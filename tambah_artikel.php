...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO artikel (judul, konten, gambar_url, konten_url, kategori) 
              VALUES ('$judul', '$konten', '$gambar_url', '$konten_url', '$kategori')";
...
<head>
    ...
    <style>
        .form-container{max-width:800px;margin:30px auto;padding:30px;background:white;border-radius:15px}
        .form-group{margin-bottom:20px}
        label{display:block;margin-bottom:5px;font-weight:bold}
        input,textarea,select{width:100%;padding:10px;border:1px solid #ddd;border-radius:5px}
        textarea{height:200px}
        button{background:#0e4496;color:white;border:none;padding:10px 20px;border-radius:5px;cursor:pointer}
        small{color:#777;display:block;margin-top:3px}
        .tab-container{margin-bottom:20px}
        .tab{display:inline-block;padding:10px 20px;cursor:pointer;background:#eee;border-radius:5px 5px 0 0}
        .tab.active{background:#0e4496;color:white}
